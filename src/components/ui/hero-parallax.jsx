...
export const HeroParallax = ({ products }) => {
  ...
  return (
    <div
      ref={ref}
      className="w-full h-full overflow-hidden pb-28 antialiased relative flex flex-col self-auto [perspective:1000px] [transform-style:preserve-3d]"
    >
      <Header />
      <motion.div
        style={{
...
export const ProductCard = ({ product, translate }) => {
  return (
    <motion.div
      ...
      key={product.title}
      className="group/product h-60 w-96 relative flex-shrink-0"
    >
      <a
        href={product.link}
        target="_blank"

...
export const HeroParallax = ({ products }) => {
  ...
  return (
    <div
      ref={ref}
      className="relative flex h-full w-full flex-col self-auto overflow-hidden pb-28 antialiased [perspective:1000px] [transform-style:preserve-3d]"
    >
      <Header />
      <motion.div
        style={{
...
export const Header = () => {
  return (
    <div className="relative left-0 top-0 mx-auto w-full max-w-7xl px-4">
      ...
      <p className="mt-8 max-w-2xl text-sm text-black md:text-xl">
...
export const ProductCard = ({ product, translate }) => {
  return (
    <motion.div
      ...
      key={product.title}
      className="group/product relative h-60 w-96 flex-shrink-0"
    >
      <a
        href={product.link}
        target="_blank"
